/******************************************************************************
 * @file     vio_STM32U575I-EV.c
 * @brief    Virtual I/O implementation for board STM32U575I-EV
 * @version  V1.0.0
...
/*! \page vio_STM32U575I-EV Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | USER button (B4)     | PC13
| vioLED0       | vioSignalOut.0 | LED red     (LD6)    | PH7
| vioLED1       | vioSignalOut.1 | LED green   (LD5)    | PB7
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTH(7),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTB(7),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
